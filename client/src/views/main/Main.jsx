      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-12 text-center">
          <img
            ...
            className="h-60 mx-auto mb-6 transform rotate-[-20deg]"
          />

          <p className="text-lg text-green-300 mb-12">
            Welcome to Your Favorite Sticker Store!
          </p>
              ...
              <div className="pt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
                {products.map((product) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className="bg-gray-800 p-4 rounded shadow-md hover:shadow-lg transition duration-200 flex flex-col items-center max-w-[200px]"
                    >
                      <img
                        src={productImage}
                        alt={product.name}
